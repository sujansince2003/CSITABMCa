          ...
          <div className='event'>
            ...
            <div className='mentor'>
              ...
              <div>
                ...
                <p className='attendeesname'>Bipin Khatri, Sujan Khatri,  <a className='attendeesnamehover' title='Sanchit Pandey, Prabesh Bhandari, Pratish Bhandari' >8 others</a> </p>
              </div>
